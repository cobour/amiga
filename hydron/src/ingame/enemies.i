...
enemy_width_bytes:      rs.w       1                       ; width of enemy in bytes
...
enemy_modulo_no_shift:  rs.w       1                       ; source-modulo without pixel shift (xpos is at word-border) if full width of enemy is visible
enemy_modulo_shift:     rs.w       1                       ; source-modulo with pixel shift (xpos is NOT at word-border) if full width of enemy is visible
