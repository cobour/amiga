...
ig_om_panel_redraw_hiscore:               rs.b       1                                                       ; (countdown)-boolean / must hiscore be drawn? (is automatically triggered by redrawing score when appropriate)
ig_om_panel_dummy_byte:                   rs.b       1 
